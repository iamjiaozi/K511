...
class SearchController extends Controller
{
    ...
    public function index()
    {
		...
		testforbWords($searchtpl);
		testforbWords(get('keyword'));
		testforbSearch(get('keyword'));
		if(get('keyword', 'var') == '.'){
        ...
        $pagetitle = get('keyword', 'vars') ? htmlspecialchars(get('keyword', 'vars'), ENT_QUOTES, 'UTF-8') . '-' : '';
